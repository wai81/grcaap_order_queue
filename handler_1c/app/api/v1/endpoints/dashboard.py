...
from app.api.v1.schemas.line_order import LineOrderInDB, LineOrderCreate, LineOrderUpdate, LineOrderResponse, \
    LineOrderChangeStatus, OrderCountByOrganization, OrderCountBySatus
...
@router.get("/ordercount", response_model=List[OrderCountByOrganization], status_code=200)
...
db: AsyncSession = Depends(get_db)):
    ...
    result = [
        ...
        count, 
        completed_orders,
        not_completed_orders in orders_count
    ] 
